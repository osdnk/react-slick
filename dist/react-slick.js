...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Bar = exports.Bar = function (_React$Component) {
	  ...
	  Bar.prototype.render = function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: this.props.barClass, style: { display: 'block' } },
	      _react2.default.createElement('div', { className: this.props.barThumbClass, style: { display: 'block', width: width, transform: 'translateX(' + translate + 'px)' } })
	    );
	  };
